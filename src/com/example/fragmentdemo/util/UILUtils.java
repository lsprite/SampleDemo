...
public final class UILUtils {
					...
					new ImageLoadingListener() {
						...
						public void onLoadingComplete(String imageUri,
							...
							try {
								...
								((ImageView) view)
										.setImageBitmap(MosaicProcessor
												.makeMosaic(loadedImage, null,
														10));
							} catch (Exception e) {
	...
	public static void displayLocalImage(Context context, String imgurl,
			ImageView imageView) {
		try {
			initOptions();
			ImageLoader.getInstance().displayImage("file://" + imgurl,
	...
	public static void displayImageWithDefault(Context context, String imgurl,
			ImageView imageView) {
		try {
			initOptionsWithDefault();
			ImageLoader.getInstance().displayImage(imgurl, imageView,
					optionsWithDefault, null);
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
		}
