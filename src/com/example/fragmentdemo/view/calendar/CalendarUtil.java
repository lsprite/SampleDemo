package com.example.fragmentdemo.view.calendar;
...
public class CalendarUtil {
	...
	private static SimpleDateFormat yearMouthFormat = new SimpleDateFormat("yyyy年MM月");
	/**
	 * 转换为2012-11-22格式
	 */
	...
	public static boolean compareSameYearAndMouth(Date compareDate, Calendar currentDate) {
		currentDate.add(Calendar.DAY_OF_MONTH, -1);
		System.out.println(
				"---" + yearMouthFormat.format(compareDate) + "---" + yearMouthFormat.format(currentDate.getTime()));
		return yearMouthFormat.format(compareDate).equals(yearMouthFormat.format(currentDate.getTime()));
	}
